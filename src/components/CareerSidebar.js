...
const CareerSidebar = class extends React.Component {
  render() {
    let { location, roleType, department, applyLink } = this.props;
    ...
    return (
      <aside class="sidebar">
        ...
        <a href={applyLink} style={{marginTop: "15px", width: "100%", maxWidth: "227px"}} className="button-cta">Apply<img src={leftArrow} alt="Left Arrow" /></a> 
      </aside>
    )
  }
}
