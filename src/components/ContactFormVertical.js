...
const ContactForm = () => {
  ...
  const doneCallback = (solution) => {
    setInputs((values) => ({
      ...values,
      [friendlyCaptchaFieldName]: solution,
    }));
  };
  ...
  const errorCallback = (err) => {
    Swal.fire(
      "Validation Error",
      `Captcha solution is invalid!. ${err}`,
      "warning"
    );
  };
          ...
          <div className="form-wrapper is-vertical">
            <div className="field-column is-full-width">
              <div className="field-row ">
                ...
                <input
                  id="first_name"
                  className="contact-field lt-field"
                  maxLength="40"
                ...
                <input
                  id="last_name"
                  className="contact-field rt-field"
                  maxLength="80"
              ...
              <div className="field-row ">
                ...
                <input
                  id="email"
                  className="contact-field ct-field"
                  maxLength="80"
                  name="email"
                  value={inputs.email || ""}
                  onChange={handleChange}
            ...
            <div className="field-column is-full-width">
              <textarea
                ...
                name="00N6f00000FmlhK"
                type="text"
                placeholder="How can we help?"
                wrap="soft"
                required
                value={inputs["00N6f00000FmlhK"] || ""}
                onChange={handleChange}
              ></textarea>
              <div className="field-column is-full-width">
                <div
                  ...
                  data-sitekey={getEnvVariable(FRIENDLY_CAPTCHA_SITE_KEY)}
                />
              </div>
      ...
      {success && (
        <div id="confirmation-message">
          <div className="confirmation-text">
            Thank you for contacting the Open Infrastructure Foundation. Someone
            from the Foundation will follow up with you as soon as possible. If
            you’d like to set up a meeting directly with our business
            development team, go ahead and{" "}
            <a
