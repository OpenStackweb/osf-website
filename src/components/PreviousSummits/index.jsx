...
const PREVIOUS_SUMMITS = [
  ...
  {name: 'Denver, Colorado', date: 'April 29 - May 1, 2019', image: '/img/summit-landing/summits/denver.png', link:  '/summit/denver-2019'},
  {name: 'Shanghai, China', date: 'November 4-6, 2019', image: '/img/summit-landing/summits/shanghai.png', link:  '/summit/shanghai-2019'}
];
