        ...
        <Slider {...slideSettings} className="sponsor-logos-slider">
            ...
            <div>
                ...
                <div class="logos">
                    ...
                    <a class="logo-headline" href="https://superuser.openstack.org/" target="_blank" rel="noopener noreferrer"><img src="https://object-storage.public.mtl1.vexxhost.net/swift/v1/6e4619c416ff4bd19e1c087f27a43eea/www-assets-prod/companies/main_logo/superuser-lg2.jpg" alt="SuperUser" /></a>
                </div>
            </div>
        </Slider>
    )
