...
const UNIVERSE = [
  ...
  {name: "openEuler", link: "https://www.openeuler.org/", logo: "openeuler.png", description: "An operating system compatible with multiple computing architectures.", tags: ["OS distribution"], isOIF: false},
