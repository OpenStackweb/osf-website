...
* On the mailing list: \[service-discuss@lists.opendev.org](<mailto:service-discuss@lists.opendev.org
  *>)
* \[](<mailto:service-discuss@lists.opendev.org
...
(Eleven newsletters were distributed to the open infrastructure community with more than 52,000 people opening at least one newsletter in the past year, as well as 121,000 unique views on all the newsletters.(insert graphic below) 
...
In 2022, the Foundation reached over 420,000 followers on Twitter, Facebook and LinkedIn and made over 2,700,000 impressions. The Foundation is also running multiple WeChat accounts and groups that cover various topics including OpenStack, Kata Containers, StarlingX, multi-arch SIG and more, specifically tailored to the OpenInfra community in China. In addition, the OpenInfra Foundation joined the community on [Mastodon](https://fosstodon.org/@openinfra).
