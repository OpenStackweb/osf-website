...
---
### OpenInfra Momentum Grows in India

The OpenInfra Foundation returned from KubeCon + CloudNativeCon India 2026 with a clear takeaway: the open infrastructure community across the region is thriving. The Foundation booth drew consistent crowds throughout the event, with conversations spanning OpenStack deployments, edge computing, digital sovereignty, and AI infrastructure. Notably, the most common question from attendees was not how to deploy the software, but how to contribute. 

That enthusiasm extended beyond the conference floor: the [OpenInfra User Group India](https://www.meetup.com/indian-openinfra-user-group/) meetup drew more than 400 registrations, bringing together operators, developers, and newcomers to exchange experiences and build the relationships that sustain open source communities over time.

With Platinum Member [Wind River](https://www.windriver.com/) supporting technical conversations about StarlingX at the booth, Silver Member [Coredge](https://coredge.io/) drawing its own packed crowd nearby, and [NPCI](https://sched.co/2NlyU) sharing its OpenStack-powered infrastructure story from the keynote stage, the event offered a vivid picture of how deeply open infrastructure has taken root across India and how much momentum this community carries heading into the rest of the year.

### OpenInfra Foundation News

* OpenInfra Foundation board member Johan Christenson wrote [an article in Enterprise Times](https://www.enterprisetimes.co.uk/2026/06/18/without-digital-sovereignty-there-is-no-sovereignty/) about why open source infrastructure is where sovereignty lives, and why the window to act is now.
...
* OpenInfra + KCD Vietnam | 25 July
  ...
  * [Learn More](https://t.e2ma.net/click/ud4ini/igq4cs/6udf08) | [Register](https://t.e2ma.net/click/ud4ini/igq4cs/mnef08) | [Sponsors](https://2026.vietopeninfra.org/vi/#sponsors)
* OpenStack Booth at KubeCon + CloudNativeCon Japan | July 28-30

  * [Learn More](https://events.linuxfoundation.org/kubecon-cloudnativecon-japan/register/) | Booth # SU7
