...
seo:
  title: "Meet NETWAYS: Building Sovereign Cloud Solutions with Open Source
    Technologies"
  description: NETWAYS is committed to giving back to the upstream community that
    makes their work possible by contributing code, sharing knowledge, and
    participating in the global exchange of ideas that OpenInfra enables.
