...
seo:
  title: Strengthening Open Source Communities through Community Management and
    Mindset
  url: https://openinfra.org/blog/openinfra-community-management
  twitterUsername: "@openinfradev"
  description: Ildikó has been involved in and working with open source projects
    for more than a decade, and through those experiences, she has learned how
    individuals and companies in these communities work together, or at least
    try to.
---
