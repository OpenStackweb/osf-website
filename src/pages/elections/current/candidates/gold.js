...
const ElectionGoldCandidatesPageTemplate = ({ goldCandidates, electionStatus, today }) => {
...
const ElectionGoldCandidatesPage = ({ isLoggedUser, goldCandidates, location, getGoldCandidates, electionStatus, getElectionStatus }) => {
