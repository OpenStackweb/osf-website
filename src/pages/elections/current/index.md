...
When considering which candidates are best equipped to serve in this capacity, voters can review each candidate's application on the [candidate](/elections/current/candidates) page prior to the start of the election.
...
A candidate's responses will appear on their public profile, as well as on [the candidates page](/elections/current/candidates).
