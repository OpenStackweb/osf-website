...
const berlin2022SummitOnsitePage = ({ isLoggedUser, data }) => {
...
berlin2022SummitOnsitePage.propTypes = {
  data: PropTypes.object.isRequired,
}

export default connect(state => ({
  isLoggedUser: state.loggedUserState.isLoggedUser
}), null)(berlin2022SummitOnsitePage)

export const berlin2022SummitOnsitePageQuery = graphql`
  query berlin2022SummitOnsitePage($id: String!) {
