        ...
        <div className="join-header ptg-header">
            <div className="header-right">
                ...
                <span className="description">
                    ...
                    <br />
                    <br />
                    <p>Make sure you <a className="primary-link-color" href="https://openinfrafoundation.formstack.com/forms/oct2023_ptg_team_signup">sign up your team</a> if that hasn't been done already. Responses are due by August 20, 2023.</p>
                </span>
