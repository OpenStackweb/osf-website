          ...
          <div className="ptg-header-bottom">
            ...
            <div className="ptg-header-bottom-container">
              <div className="ptg-header-bottom-left">
                ...
                <p>
                  ...
                  <a
                    ...
                    href="https://openinfrafoundation.formstack.com/forms/march2023_vptg_survey"
                  >
                    sign up your team
                  </a>{" "}
              ...
              {/* <div className="ptg-header-bottom-right">
                ...
                <p>Make sure you <a class="primary-link-color" href="https://openinfrafoundation.formstack.com/forms/oct2023_ptg_team_signup">sign up your team</a> if that hasn't been done already</p>
                </div> */}
            </div>
          </div>
        </div>
