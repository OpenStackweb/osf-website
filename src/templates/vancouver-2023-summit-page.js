            ...
            <section className="summit-header summit-header-vancouver-2023">
              <div className="header-left summit-header-videos">
                ...
                <div className="chaoss-badge-container">
                  <p className="small-details">A <a href="https://github.com/badging/event-diversity-and-inclusion/blob/main/.github/checklist.md">CHAOSS Gold Badge</a> recipient</p> 
