...
const VancouverSchedulePageTemplate = ({
                                  summit,
                                  scheduleState,
                                  isLoggedUser,
                                  updateFilter,
...
VancouverSchedulePageTemplate.propTypes = {
...
const ConnectedSchedTemplate = withScheduleData(VancouverSchedulePageTemplate);

const VancouverSchedulePage = ({location, schedKey, headerTitle, data, ...rest}) => {
...
export default VancouverSchedulePage;

export const vancouverSummitScheduleQuery = graphql`
  query VancouverSummitSchedule($id: String!) {
