...
export const HOME_SUBPROJECT_ID = 'HOME_SUBPROJECT_ID';
...
const processEnv = {
  ...
  HOME_SUBPROJECT_ID: process.env.GATSBY_HOME_SUBPROJECT_ID,
}
...
if (typeof window === 'object') {
  ...
  window.HOME_SUBPROJECT_ID = processEnv[HOME_SUBPROJECT_ID];
}
